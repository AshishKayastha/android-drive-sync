...
import com.example.android.cloudnotes.appwidget.WidgetProvider;
...
public class NoteEditFragment extends Fragment {
    ...
    // launch actions
    public static final String ACTION_CREATE_NOTE = "com.example.android.cloudnotes.ACTION_CREATE_NOTE";
    public static final String ACTION_VIEW_NOTE = "com.example.android.cloudnotes.ACTION_VIEW_NOTE";
    public static final String ACTION_EDIT_NOTE = "com.example.android.cloudnotes.ACTION_EDIT_NOTE";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(NotesProvider.KEY_ID)) {
            mCurrentNote = Uri.parse((String) savedInstanceState.getString(NotesProvider.KEY_ID));
        }
    ...
    private void populateFields() {
        if (mCurrentNote != null) {
            ...
            Cursor c = null;
            try {
                c = getActivity().getContentResolver().query(mCurrentNote, null, null, null, null);
                if (c.moveToFirst()) {
    ...
    private void saveNote() {
        ...
        if (updating) {
            ...
            Uri newNote = getActivity().getContentResolver().insert(NotesProvider.CONTENT_URI,
                    values);
        ...
        Toast.makeText(getActivity(), updating ? R.string.note_updated : R.string.note_saved,
